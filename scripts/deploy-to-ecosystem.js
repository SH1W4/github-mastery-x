...
class MCPEcosystemDeployment {
  ...
  async copyIntegrationFiles() {
    ...
    try {
      const integrationDir = path.join(this.ecosystemPath, 'integrations', 'github-mastery');
  ...
  async updateEcosystemConfig() {
    ...
    try {
      const ecosystemConfigPath = path.join(this.ecosystemPath, 'config', 'mcp-ecosystem.json');
  ...
  async registerWithEcosystem() {
    ...
    try {
      ...
      const registryPath = path.join(this.ecosystemPath, 'registry', 'github-mastery.json');
