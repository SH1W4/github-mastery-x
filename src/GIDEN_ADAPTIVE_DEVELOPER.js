...
const DEVELOPER_PROFILES = {
  beginner: {
    name: 'Iniciante',
    characteristics: [
      'Pouca experiência com Git',
      'Primeiro contato com open source',
      'Foco em aprendizado',
    ],
    weeklyCommitGoal: 7,
    prGoal: 1,
...
class GIDENAdaptiveDeveloper {
  ...
  async suggestProjects() {
    const suggestions = {
      ...
      intermediate: [
        {
          name: 'Popular JS Projects',
          search: 'language:javascript stars:>1000 help-wanted',
        },
        {
          name: 'Python Projects',
          search: 'language:python stars:>500 good-first-issue',
        },
...
${Object.entries(weeklyPlan.dailyPlan)
  .map(
    ([day, plan]) =>
...
`;
  ...
  async exportCommunity() {
    ...
    await fs.writeFile(
      'GIDEN_COMMUNITY_PACKAGE.json',
      JSON.stringify(communityPackage, null, 2)
    );
